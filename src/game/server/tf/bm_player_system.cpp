...
ConVar tf_bm_grid_origin( "tf_bm_grid_origin", "0 0 0", FCVAR_REPLICATED | FCVAR_NOTIFY, "Bomberman: world origin of cell (0,0)." );
...
void BM_SnapPlayerToGrid( CTFPlayer *pPlayer )
{
	...
	vecSnapped.z = vecOrigin.z + 32.0f;

	trace_t trace;
	UTIL_TraceHull( vecSnapped, vecSnapped - Vector( 0, 0, 256.0f ), VEC_HULL_MIN, VEC_HULL_MAX, MASK_PLAYERSOLID, pPlayer, COLLISION_GROUP_PLAYER, &trace );
	vecSnapped.z = trace.endpos.z;
