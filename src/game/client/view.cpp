...
void CViewRender::Init( void )
{
	...
	materials->CreateNamedRenderTargetTextureEx("_rt_FullFrameDepth", 1, 1,
		...
		MATERIAL_RT_DEPTH_NONE, // MATERIAL_RT_DEPTH_NONE MATERIAL_RT_DEPTH_SHARED
		TEXTUREFLAGS_CLAMPS | TEXTUREFLAGS_CLAMPT | TEXTUREFLAGS_POINTSAMPLE | TEXTUREFLAGS_RENDERTARGET,
