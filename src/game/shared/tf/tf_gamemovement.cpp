...
ConVar	tf_avoidteammates_pushaway( "tf_avoidteammates_pushaway", "0", FCVAR_REPLICATED, "Whether or not teammates push each other away when occupying the same space" );
