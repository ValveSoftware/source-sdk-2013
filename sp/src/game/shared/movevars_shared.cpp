...
#else
ConVar	sv_maxspeed		( "sv_maxspeed", "275", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY); // 320
#endif // CSTRIKE_DLL
...
#else
ConVar	sv_friction		( "sv_friction","6", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "World friction." );
#endif // DOD_DLL || CSTRIKE_DLL
