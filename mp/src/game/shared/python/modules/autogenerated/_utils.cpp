...
BOOST_PYTHON_MODULE(_utils){
    ...
    bp::class_< CTraceFilterSkipTwoEntities_wrapper, bp::bases< CTraceFilterSimple > >( "CTraceFilterSkipTwoEntities", bp::init< IHandleEntity const *, IHandleEntity const *, int >(( bp::arg("passentity"), bp::arg("passentity2"), bp::arg("collisionGroup") )) )    
        .def( 
            ...
            , (void ( CTraceFilterSkipTwoEntities_wrapper::* )( ::IHandleEntity const * ) )(&CTraceFilterSkipTwoEntities_wrapper::default_SetPassEntity2)
            , ( bp::arg("pPassEntity2") ) )    
        .def( 
            "SetCollisionGroup"
            , (void ( ::CTraceFilterSimple::* )( int ) )(&::CTraceFilterSimple::SetCollisionGroup)
            , (void ( CTraceFilterSkipTwoEntities_wrapper::* )( int ) )(&CTraceFilterSkipTwoEntities_wrapper::default_SetCollisionGroup)
            , ( bp::arg("iCollisionGroup") ) )    
        .def( 
            "SetPassEntity"
            , (void ( ::CTraceFilterSimple::* )( ::IHandleEntity const * ) )(&::CTraceFilterSimple::SetPassEntity)
            , (void ( CTraceFilterSkipTwoEntities_wrapper::* )( ::IHandleEntity const * ) )(&CTraceFilterSkipTwoEntities_wrapper::default_SetPassEntity)
            , ( bp::arg("pPassEntity") ) );
    ...
    bp::class_< CTraceFilterNoNPCsOrPlayer_wrapper, bp::bases< CTraceFilterSimple > >( "CTraceFilterNoNPCsOrPlayer", bp::init< IHandleEntity const *, int >(( bp::arg("passentity"), bp::arg("collisionGroup") )) )    
        .def( 
            "SetCollisionGroup"
            , (void ( ::CTraceFilterSimple::* )( int ) )(&::CTraceFilterSimple::SetCollisionGroup)
            , (void ( CTraceFilterNoNPCsOrPlayer_wrapper::* )( int ) )(&CTraceFilterNoNPCsOrPlayer_wrapper::default_SetCollisionGroup)
            , ( bp::arg("iCollisionGroup") ) )    
        .def( 
            "SetPassEntity"
            , (void ( ::CTraceFilterSimple::* )( ::IHandleEntity const * ) )(&::CTraceFilterSimple::SetPassEntity)
            , (void ( CTraceFilterNoNPCsOrPlayer_wrapper::* )( ::IHandleEntity const * ) )(&CTraceFilterNoNPCsOrPlayer_wrapper::default_SetPassEntity)
            , ( bp::arg("pPassEntity") ) );
