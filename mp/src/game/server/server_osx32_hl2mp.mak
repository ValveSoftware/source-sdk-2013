...
FORCEINCLUDES= 
ifeq "$(CFG)" "debug"
DEFINES += -DDEBUG -D_DEBUG -DGNUC -DPOSIX -D_OSX -DOSX -D_DARWIN_UNLIMITED_SELECT -DFD_SETSIZE=10240 -DQUICKTIME_VIDEO -DFORCE_QUICKTIME -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DGAME_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dsprintf=use_Q_snprintf_instead_of_sprintf -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DSWDS -DHL2MP -DHL2_DLL -DVPCGAMECAPS=HL2MP -DPROJECTDIR=/Users/joe/p4/ValveGames/rel/hl2/src/game/server -D_DLL_EXT=.dylib -DVPCGAME=hl2mp -D_POSIX=1 
else
DEFINES += -DNDEBUG -DGNUC -DPOSIX -D_OSX -DOSX -D_DARWIN_UNLIMITED_SELECT -DFD_SETSIZE=10240 -DQUICKTIME_VIDEO -DFORCE_QUICKTIME -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DGAME_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dsprintf=use_Q_snprintf_instead_of_sprintf -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DSWDS -DHL2MP -DHL2_DLL -DVPCGAMECAPS=HL2MP -DPROJECTDIR=/Users/joe/p4/ValveGames/rel/hl2/src/game/server -D_DLL_EXT=.dylib -DVPCGAME=hl2mp -D_POSIX=1 
endif
INCLUDEDIRS += ../../common ../../public ../../public/tier0 ../../public/tier1 ../../game/server/generated_proto_mod_hl2mp ../../thirdparty/protobuf-2.3.0/src ./ ../../game/shared ../../utils/common ../../game/shared/econ ../../game/server/NextBot ../../game/shared/hl2 ./hl2 ./hl2mp ../../game/shared/hl2mp 
CONFTYPE = dll
IMPORTLIBRARY = 
GAMEOUTPUTFILE = ../../../game/mod_hl2mp/bin/server.dylib
OUTPUTFILE=$(OBJ_DIR)/server.dylib
THIS_MAKEFILE = $(PWD)/server_osx32_hl2mp.mak
...
$(OBJ_DIR)/grenade_satchel.o : $(PWD)/hl2mp/grenade_satchel.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/grenade_tripmine.o : $(PWD)/hl2mp/grenade_tripmine.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mp_bot_temp.o : $(PWD)/hl2mp/hl2mp_bot_temp.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mp_client.o : $(PWD)/hl2mp/hl2mp_client.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mp_cvars.o : $(PWD)/hl2mp/hl2mp_cvars.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mp_gameinterface.o : $(PWD)/hl2mp/hl2mp_gameinterface.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mp_player.o : $(PWD)/hl2mp/hl2mp_player.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/te_hl2mp_shotgun_shot.o : $(PWD)/hl2mp/te_hl2mp_shotgun_shot.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/team_control_point.o : $(PWD)/team_control_point.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/team_control_point_master.o : $(PWD)/team_control_point_master.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/team_control_point_round.o : $(PWD)/team_control_point_round.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/team_objectiveresource.o : $(PWD)/team_objectiveresource.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/team_train_watcher.o : $(PWD)/team_train_watcher.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/trigger_area_capture.o : $(PWD)/trigger_area_capture.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
