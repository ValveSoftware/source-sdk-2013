...
all-targets : server_hl2mp client_hl2mp tier1 vgui_controls mathlib 
...
server_hl2mp : tier1 mathlib 
	...
	@+cd game/server && $(MAKE) -f server_osx32_hl2mp.mak $(CLEANPARAM)

client_hl2mp : tier1 vgui_controls mathlib 
	@echo "Building: client_hl2mp"
	@+cd game/client && $(MAKE) -f client_osx32_hl2mp.mak $(CLEANPARAM)
...
.PHONY: TAGS showtargets regen showregen clean cleantargets cleanandremove relink server_hl2mp client_hl2mp tier1 vgui_controls mathlib 
